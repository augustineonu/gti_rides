...
class ReturningSplashScreenBinding extends Bindings {
  @override
  void dependencies() {
...
class ReturningUserSplashScreen extends GetView<ReturningUserSplashController> {
  const ReturningUserSplashScreen({super.key});
